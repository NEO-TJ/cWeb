    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
        <ul class="nav navbar-nav">
          ...
          <div class="dropdown">
            <a href=<?= base_url("Welcome/about2") ?>><button class="dropbtn">About - <?php echo base_url("Welcome/about2"); ?></button></a>
          <div class="dropdown-content">
        </div>
      </div>
      <div class="dropdown">
      ...
      <div class="dropdown">
        <?php if ($this->session->userdata('weblogin')) { $datases = $this->session->userdata('weblogin'); ?>
        <button class="dropbtn">welcome <?= $datases['login_name'] ?></button>
        <div class="dropdown-content">
          <ul>
            <?php if ($datases['login_permit'] == 3) { ?>
