        ...
        if ($this->session->userdata('weblogin')) {
            ...
            if ($check_login) {
                foreach ($check_login as $datases) {
                    ...
                    $data = array(
                        'login_id' => $datases['login_id'],
                        'login_email' => $datases['login_email'],
                        'login_name' => $datases['login_name'],
                        'login_permit' => $datases['login_permit'],
                        'login_status' => $datases['login_status'],
                        'login_img' => $datases['login_img'],
